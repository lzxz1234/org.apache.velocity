...
import org.apache.velocity.runtime.directive.OverrideDirective.OverrideNodeWrapper;
...
public class BlockDirective extends org.apache.velocity.runtime.directive.Directive {
    ...
    public boolean render(InternalContextAdapter context, Writer writer, Node node)
        ...
        OverrideNodeWrapper overrideNode = (OverrideNodeWrapper) context.get(Utils.getOverrideVariableName(name));
