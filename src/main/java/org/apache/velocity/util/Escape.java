...
public class Escape {
    ...
    static final EntityMap map = new EntityMap();
    static {
    ...
    public static String escape(String str) {
        StringWriter stringWriter = new StringWriter((int) (str.length() * 1.1));
        try {
    ...
    private static class EntityMap {
        ...
        private final Map<String, Object> mapNameToValue = new HashMap<String, Object>();
        ...
        private void createLookupTable() {
            ...
            for (int i = 0; i < LOOKUP_TABLE_SIZE; ++i) {
                lookupTable[i] = (String) mapValueToName.get(i);
            }
        }
    }
